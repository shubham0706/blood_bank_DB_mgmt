...
$q = "SELECT  
name AS name,address AS address, units AS units, btype As btype FROM branches 
WHERE name = '&venue'
";
...
if ($result) { // If it ran OK, display the records
					...
					// Table header. 
				echo '<table>
				<tr class="heading"><td class="col head"> <b>Name</b></td> <td class="col head"><b>Units</b></td>
				<td class="col head"><b>Type</b></td>
				<td class=" last"><b>Address</b></td>
				...
				<td class="col">' . $row['units'] .'</td>
				<td class="col">' . $row['btype'] .'</td>
				<td class="last1">'.  $row['address'] . '</td>
